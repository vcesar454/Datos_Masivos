...
def GBTClassfier(N_iterations : Int): Unit = {
    
    var i = 1;
    val data = spark.read.format("libsvm").load("sample_data/sample_libsvm_data.txt")
...
(1 to 30 by 1).foreach(v => time(GBTClassfier(30)))